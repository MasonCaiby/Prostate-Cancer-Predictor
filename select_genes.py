...
X = pd.read_csv('Prostate-Cancer-Predictor/genes_from_pivot2.csv')
X_data = X.values
y = pd.read_csv('Prostate-Cancer-Predictor/labels_from_pivot2.csv', index_col=0)
...
top_hund_genes = np.array(list(top_hundred_genes))
...
select_df.to_csv('select_genes.csv')
